...
Hier ein Beispiel Command für die Bewegung nach links und rechts:
...
Dies wurde mit folgenden Flags, welche das nach rechts/links laufen (wie oben gezeigt) bedingen:
...
Gonzales hat eine "3-Schuss-Waffe". Er feuert also eine Salve bestehend aus 3 Schüssen und macht Schaden, sobald mindestens eine dieser 3 Projektile trifft.

Hier ein Beispiel code für ein Projektil (der Laserschuss von Alphonzo; der Code für die Projektile von Gonzales ist der gleiche):
...
Die Fähigkeit besteht einmal aus dem Code für die Bewegung und die Defnition der Variable um die Flag zu aktivieren, dass der Slam benutzt wurde:
...
Dem Umfang unseres Projekts entsprechend hatten wir zahlreiche, teils unerklährliche Fehlschläge.
...
Unser größtes Probelm welches über Monate ungelößt blieb, jedoch zuletzt gelößt werden konnte war der Block.
...
Sich etwas wie das Programmieren mit Snap anzueignen um etwas verwirklichen zu können das man sich slebst vorgestellt hatte, wie eben unser Spiel, hat das Arbeiten sehr erleichtert und angenehm gemacht. 
Auch wenn gelegentliche Einschränken durch die Block-Programmiersprache und/oder Bugs beim Arbeiten frustrierend waren, war es früher oder später umso schöner die Lösung zu finden.
